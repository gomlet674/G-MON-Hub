...
local function AddSwitch(page, text, flag)
    ...
    -- tombol switch (tanpa teks)
    local sw = New("TextButton", {
        Text = "",                       -- <--- pastikan kosong
        TextTransparency = 1,            -- <--- sembunyikan segala teks
