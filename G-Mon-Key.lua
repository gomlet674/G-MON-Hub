...
-- TextBox (dikecilkan jadi 70% width)
...
input.Focused:Connect(function()    input.TextTransparency = 0 end)
input.FocusLost:Connect(function() 
    if input.Text == "" then input.TextTransparency = 1 end
end)
...
checkBtn.MouseButton1Click:Connect(function()
    ...
    if key == VALID_KEY then
        ...
        task.wait(0.5)
        screenGui:Destroy()
        -- pakai loader() bukannya langsung loadstring()
        if loader then
            ...
            warn("loadstring/load tidak tersedia")
        end
    else
        StarterGui:SetCore("SendNotification", {
