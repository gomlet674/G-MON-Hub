...
closeBtn.Size = UDim2.new(0,24,0,24); closeBtn.Position = UDim2.new(1,-30,0,8)
...
input.Size = UDim2.new(0.8,0,0,28); input.Position = UDim2.new(0.1,0,0.4,0)
input.PlaceholderText = "Enter Key..."; input.ClearTextOnFocus = true
input.BackgroundColor3 = Color3.fromRGB(30,30,30); input.TextColor3 = Color3.new(1,1,1)
input.Font = Enum.Font.Gotham; input.TextSize = 14
Instance.new("UICorner", input).CornerRadius = UDim.new(0,6)

-- Transparan kecuali saat di-focus
input.TextTransparency = 1; input.PlaceholderTextTransparency = 0.5
input.Focused:Connect(function()
    input.TextTransparency = 0; input.PlaceholderTextTransparency = 0
end)
...
checkBtn.Size = UDim2.new(0.35,0,0,28); checkBtn.Position = UDim2.new(0.1,0,0.75,0)
checkBtn.Font = Enum.Font.GothamBold; checkBtn.TextSize = 14
checkBtn.TextColor3 = Color3.new(1,1,1); checkBtn.Text = "Check Key"
checkBtn.BackgroundColor3 = Color3.fromRGB(50,100,50)
Instance.new("UICorner", checkBtn).CornerRadius = UDim.new(0,6)

local getKeyBtn = Instance.new("TextButton", frame)
getKeyBtn.Size = UDim2.new(0.35,0,0,28); getKeyBtn.Position = UDim2.new(0.55,0,0.75,0)
getKeyBtn.Font = Enum.Font.GothamBold; getKeyBtn.TextSize = 14
getKeyBtn.TextColor3 = Color3.new(1,1,1); getKeyBtn.Text = "Get Key"
...
checkBtn.MouseButton1Click:Connect(function()
    if input.Text == VALID_KEY then
        StarterGui:SetCore("SendNotification", {
            Title = "Valid Key", Text = "Loading…", Duration = 2
        })
        task.wait(0.5)
        screenGui:Destroy()
        -- muat main.lua
